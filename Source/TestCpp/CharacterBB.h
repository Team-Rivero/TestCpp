...
enum class EPlayerKeyAction : uint8
{
	...
	TestKey UMETA(Tooltip = "Check if the player has a speicfic key.")
};

//Delegate for when actions occur with the player's keys.
//KeyString is the key invovled in the action.
...
#pragma region Health
	...
	// Modify the player's helath by the specified amount
