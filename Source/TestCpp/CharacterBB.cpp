...
// Sets default values. Doesn't actually change it!?! It appears to have in the tutorial https://youtu.be/wJo5tusarvY?si=r_V1Obku1vQHqnmR&t=1690
...
#pragma region Update Stamina
	...
	CurrentStamina = FMath::Clamp(CurrentStamina + ActualStaminaRecuperationFactor, 0.0f, MaxStamina);
...
void ACharacterBB::UpdateHealth(int DeltaHealth)
{
	...
	//In this case it will never be less than -1, or more than MaxHealth
...
void ACharacterBB::PsiBlast()
{
	...
	//Check we have at least that before allowing the function to work
